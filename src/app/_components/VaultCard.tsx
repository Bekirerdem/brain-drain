...
// loader. Pulling that into a "use client" component bundles the env
// schema into the browser and crashes at boot ("Invalid environment").
import { VAULT_CATEGORY_LABELS, type Vault } from "@/lib/supabase/types";
