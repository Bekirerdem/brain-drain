...
- **Google Gemini 3.1 Pro Preview** for reasoning, `gemini-embedding-001` for RAG, `gemini-2.5-flash` for cheap fallback; Anthropic Claude Haiku 4.5 optional for multi-model demo
